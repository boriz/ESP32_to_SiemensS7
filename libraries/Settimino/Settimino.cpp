...
// TODO: Forcing to use NetworkClient object for this ESP32-P4 demo. 
// #ifdef S7WIFI	
...
{
	Serial.print("S7 connecting: ");
	Serial.print(Peer);
	Serial.print("; Port: ");
	Serial.println(isotcp);

	if (TCPClient->connect(Peer, isotcp))
	{
		Serial.println("S7 Connected");
		return SetLastError(0);
	}
	else
	{
		Serial.println("S7 Failed");
